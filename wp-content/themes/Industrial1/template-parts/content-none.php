...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php _e( 'Нищо не е намерено', 'twentysixteen' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php _e( 'Съжаляваме, но нищо не съвпада с търсеното. Моля опитайте с други критерии.', 'twentysixteen' ); ?></p>
			<?php get_search_form(); ?>
